...
import GetTreino from "@/Services/Treino/GetTreino";
import GetTreinos from "@/Services/Treino/GetTreinos";
import { navigate } from "@/Navigators/utils";
import DeleteTreino from "@/Services/Treino/DeleteTreino";
...
const TreinosForm = ({ id, name, description, type, benefits }: Props) => {
      ...
      await (id, {
        ...
        .then(resp => {
          if (resp?.data.success) {
            ...
            navigate('TreinosScreen', {}) //TODO.. criar tela
          } else {
            setIsLoading(false)
    ...
    >
      ...
      >
        <Picker
          ...
          onValueChange={itemValue => setTreino({ ...treino, type: itemValue })}
        >
